            ...
            $("#registration-form2").validate({
                rules: {
                    ...
                    IDCard: {
                        ...
                        remote: {       //验证身份证是否存在
                            type: "POST",
                            url: "../../Module/reg/getlCard.string?_a=1",
                            data: {
                    ...
                    Mail: {
                        ...
                        remote: {       //验证邮箱是否存在
                            type: "POST",
                            url: "../../Module/reg/getlMail.string?_a=1",
                            data: {
                ...
                submitHandler: function (form) {
                    $("#registration-form2").ajaxSubmit({
                        ...
                        dataType: "json", //数据类型 
                        async: false,
                        url: "../../Module/reg/newlreg.tjson?_n=db2", //请求url
                        success: function (data) { //提交成功的回调函数  
                    ...
                    $("#registration-form2").ajaxSubmit({
                        ...
                        dataType: "json", //数据类型 
                        async: false,
                        url: "../../Module/reg/newlowyerreg.tjson?_n=db2", //请求url
                        success: function (data) { //提交成功的回调函数  
                            $(".loading-text").show(400).delay(100).hide(400);
                            $("#registration-form2").hide();
                            $("#registration-form3").show();
                ...
                messages: {
                    ...
                    lawyerpractice: {
                        required: "请输入你的律师执业证号"
                    },
                    Name: {
                        required: "请输入你的律师事务所名称"
                    },
                    Address: {
                        required: "请输入你的律师事务所地址",
